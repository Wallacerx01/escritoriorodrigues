      ...
      >
        {areas.map((area, index) => (
          <motion.div
            ...
            className="w-full md:w-96 lg:w-96 border border-[#1B263B] bg-[#0D1B2A]/60 backdrop-blur-sm hover:bg-[#0D1B2A]/80 transition-all duration-300 rounded-xl p-6 text-white shadow-md hover:shadow-xl"
          >
